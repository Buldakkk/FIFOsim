...
Partial Class Simulator
    ...
    Private Sub InitializeComponent()
        ...
        lblVMS.Location = New Point(580, 175)
        lblVMS.Name = "lblVMS"
        ...
        Label2.Location = New Point(557, 38)
        Label2.Name = "Label2"
        ...
        Panel1.Controls.Add(lblNoOfStringOutput)
        Panel1.Controls.Add(lblRefStringOutput)
        Panel1.Controls.Add(Label7)
        Panel1.Controls.Add(Label8)
        Panel1.Controls.Add(Label2)
        Panel1.Location = New Point(12, 537)
        Panel1.Name = "Panel1"
        Panel1.Size = New Size(1350, 664)
        Panel1.TabIndex = 4
        ' 
        ' Panel2
        ' 
        ...
        Label3.Location = New Point(76, 261)
        Label3.Name = "Label3"
        ...
        Label6.Location = New Point(389, 325)
        Label6.Name = "Label6"
        ...
        lblRefStringInput.Location = New Point(389, 261)
        lblRefStringInput.Name = "lblRefStringInput"
        lblRefStringInput.Size = New Size(172, 42)
        lblRefStringInput.TabIndex = 9
        lblRefStringInput.Text = "adfgadfgd"
        ' 
        ' cmbNoOfString
        ' 
        cmbNoOfString.FormattingEnabled = True
        cmbNoOfString.Location = New Point(389, 335)
        ...
        ' btnGenerate
        ' 
        btnGenerate.Anchor = AnchorStyles.Top Or AnchorStyles.Bottom Or AnchorStyles.Left Or AnchorStyles.Right
        ...
        btnGenerate.Location = New Point(1060, 261)
        ...
        lblRefStringOutput.Location = New Point(343, 161)
        lblRefStringOutput.Name = "lblRefStringOutput"
        lblRefStringOutput.Size = New Size(172, 42)
        lblRefStringOutput.TabIndex = 14
        lblRefStringOutput.Text = "adfgadfgd"
        ' 
        ' lblNoOfStringOutput
        ' 
        ...
        lblNoOfStringOutput.Location = New Point(343, 225)
        lblNoOfStringOutput.Name = "lblNoOfStringOutput"
        lblNoOfStringOutput.Size = New Size(172, 42)
        lblNoOfStringOutput.TabIndex = 15
        lblNoOfStringOutput.Text = "adfgadfgd"
        ' 
        ' btnSimulate
        ' 
        btnSimulate.Anchor = AnchorStyles.Top Or AnchorStyles.Bottom Or AnchorStyles.Left Or AnchorStyles.Right
        ...
        btnSimulate.Location = New Point(574, 456)
